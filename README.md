...
```
╔════════════════════════════════════════════════════════════════╗
║  HOW IT WORKS: Emergency Detection in Action                  ║
╠════════════════════════════════════════════════════════════════╣
║                                                                ║
║  Frame 1: Normal              Frame 2: Emergency Detected!     ║
║  ┌──────────────────┐         ┌──────────────────┐            ║
║  │  [📹] CCTV       │         │  [📹] CCTV  🚨   │            ║
║  │                  │         │                  │            ║
║  │                  │         │      🔥          │            ║
...
║                                └──────────────────┘            ║
║                                                                ║
║  Frame 3: Response              Frame 4: Help Arrives!         ║
║  ┌──────────────────┐         ┌──────────────────┐            ║
║  │  [📹] CCTV  🚨🔴│         │  [📹] CCTV       │            ║
║  │                  │         │                  │            ║
║  │  📞 → 🚒 Fire   │         │    🚒💨          │            ║
...
║  ⏱️  Detection to dispatch: <1 second                         ║
╚════════════════════════════════════════════════════════════════╝
```
